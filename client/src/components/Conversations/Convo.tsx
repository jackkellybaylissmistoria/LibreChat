...
export default function Conversation({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        'group relative flex h-11 w-full items-center rounded-xl outline-none transition-[background-color,color] duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary/50 md:h-9',
        isActiveConvo || isPopoverActive
          ? 'bg-surface-active-alt text-text-primary before:absolute before:bottom-1.5 before:left-0 before:top-1.5 before:w-[3px] before:rounded-full before:bg-primary'
          : 'text-text-secondary hover:bg-surface-tertiary/55 hover:text-text-primary',
      )}
      role="button"
