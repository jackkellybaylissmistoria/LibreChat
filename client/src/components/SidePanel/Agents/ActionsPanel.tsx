  ...
  useEffect(() => {
    if (action?.metadata.auth) {
      reset({
        ...
        api_key_set: action.metadata.api_key_set ?? false,
        authorization_type: action.metadata.auth.authorization_type || AuthorizationTypeEnum.Basic,
        oauth_client_id: action.metadata.oauth_client_id ?? '',
        oauth_client_id_set: action.metadata.oauth_client_id_set ?? false,
        oauth_client_secret: action.metadata.oauth_client_secret ?? '',
        oauth_client_secret_set: action.metadata.oauth_client_secret_set ?? false,
